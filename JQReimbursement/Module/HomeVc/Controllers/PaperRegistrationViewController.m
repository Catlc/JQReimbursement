//
//  PaperRegistrationViewController.m
//  JQReimbursement
//
...
@interface PaperRegistrationViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
@implementation PaperRegistrationViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"票据登记";
    // Do any additional setup after loading the view.
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.botlabel.text = [@[@"住宿",@"交通",@"餐饮",@"通讯",@"其他"]objectAtIndex:indexPath.row];
